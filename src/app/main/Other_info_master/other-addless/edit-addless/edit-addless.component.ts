...
@Component({
  selector: 'app-edit-addless',
  templateUrl: './edit-addless.component.html',
  styleUrls: ['./edit-addless.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class EditAddlessComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EditAddlessComponent>,
  ...
  onSubmit() {
    ...
    console.log()
        ...
        var m_data = {
          "updateAddless": {
            "operation": "UPDATE",
            "AddLessId ": this.data.registerObj.AddLessId,
            "AddLessName": this._OtherinfoMasterService.otherallform.get('AddLessName').value ||  '',
